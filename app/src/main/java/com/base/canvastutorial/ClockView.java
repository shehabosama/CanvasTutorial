...
public class ClockView extends View {
    ...
    private int handTruncation,houHandTruncation = 0;
    ...
    public ClockView(Context context , AttributeSet attr , int defStyleAttr){
    ...
    private void drawHand(Canvas canvas , double loc , boolean isHour){
        ...
        int handRadius = isHour?radius - handTruncation - houHandTruncation : radius - handTruncation;
        canvas.drawLine(
                width/2,
                height/2,
